<template>
  <AppLayout title="API Token Menager">
    <div>
      <!-- Generate API Token -->
      <jet-form-section @submitted="createApiToken">
        ...
        <template #actions>
          <jet-button :class="{ 'text-white-50': createApiTokenForm.processing }"
              ...
              <div>
                <div class="d-flex justify-content-between" v-for="token in tokens" :key="token.id">
                  ...
                  <div class="d-flex">
                    ...
                    <button class="btn btn-link text-secondary" @click="manageApiTokenPermissions(token)"
      ...
      <jet-dialog-modal id="managingPermissionsForModal">
        ...
        <template #footer>
          ...
          <jet-button class="ms-2" @click="updateApiToken" :class="{ 'text-black-50': updateApiTokenForm.processing }"
      ...
      <jet-confirmation-modal id="apiTokenBeingDeletedModal">
        ...
        <template #footer>
          ...
          <jet-danger-button class="ms-2" @click="deleteApiToken"
            :class="{ 'text-white-50': deleteApiTokenForm.processing }" :disabled="deleteApiTokenForm.processing">
            Delete
          </jet-danger-button>
        </template>
